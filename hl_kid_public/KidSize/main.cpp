...
#ifdef VISION_COMPONENT
Vision_obj::Robocup* visionRobocup = nullptr;
Vision_obj::LocalisationBinding* locBinding = nullptr;
#endif
...
#ifdef VISION_COMPONENT
        std::cout << "Initializing Vision_obj" << std::endl;
        visionRobocup = new Vision_obj::Robocup(moveScheduler);
        std::cout << "Vision initialized." << std::endl;
        std::cout << "Initializing LocalisationBinding" << std::endl;
        std::cout << moveScheduler <<std::endl;
        std::cout << visionRobocup <<std::endl;
         
        locBinding = new Vision_obj::LocalisationBinding(moveScheduler, visionRobocup);
