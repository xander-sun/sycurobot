 ...
 * framework
 */
class Robocup : public Vision_obj::Application::Application {
  friend class Vision_obj::RobocupBenchmark; // RobocupBenchmark need an access
  friend class Vision_obj::LogBenchmark;     // LogBenchmark need an access
private:
  /**
   * Note on mutex:
   * - globalMutex:
...
public:
  ...
  std::vector<Vision_obj::Filters::FieldBorderData> stealClipping();
...
private:
  ...
  std::vector<Vision_obj::Filters::FieldBorderData> clipping_data;
