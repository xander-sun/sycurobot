...
ArenaCornerObservation::ArenaCornerObservation(const Vision_obj::Filters::FieldBorderData & brut_data_,
...
Vision_obj::Filters::FieldBorderData ArenaCornerObservation::getBrutData() {
  return brut_data;
}
