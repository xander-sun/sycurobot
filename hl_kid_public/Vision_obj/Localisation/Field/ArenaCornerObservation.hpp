...
private:
  Vision_obj::Filters::FieldBorderData brut_data;
...
public:
   ...
   */
  ArenaCornerObservation(const Vision_obj::Filters::FieldBorderData & brut_data_,
  ...
  Vision_obj::Filters::FieldBorderData getBrutData();
