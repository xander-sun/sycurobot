...
const std::vector<cv::Rect> & BallProvider::getBalls() const
{
  return balls;
}

const std::vector<cv::Rect> & BallProvider::getGoals() const
{
  return goals;
}

const std::vector<cv::Rect> & BallProvider::getRobots() const
{
  return robots;
}

const std::vector<cv::Rect> & BallProvider::getXs() const
{
  return Xs;
}
...
//}
void BallProvider::pushBall(cv::Rect &box)
{
  balls.push_back(box);
}

void BallProvider::pushGoal(cv::Rect &box)
{
  goals.push_back(box);
}

void BallProvider::pushRobot(cv::Rect &box)
{
  robots.push_back(box);
}

void BallProvider::pushX(cv::Rect &box)
{
  Xs.push_back(box);
}
