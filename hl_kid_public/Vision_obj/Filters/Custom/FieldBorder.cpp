...
void FieldBorder::init_params(cv::Mat & green, cv::Mat & green_density) {
  ...
  Vision_obj::Localisation::ArenaCornerObservation::potential_pos50 = potential_pos50;
  Vision_obj::Localisation::ArenaCornerObservation::potential_angle50 = potential_angle50;
  Vision_obj::Localisation::ArenaCornerObservation::potential_exp = potential_exp;
  Vision_obj::Localisation::ArenaCornerObservation::pError = potential_error;
