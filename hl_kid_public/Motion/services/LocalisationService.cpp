...
#ifdef VISION_COMPONENT
using namespace Vision_obj::Field;
using Vision_obj::Localisation::FieldPF;
#endif
...
#ifdef VISION_COMPONENT
void LocalisationService::setRobocup(Vision_obj::Robocup *robocup_)
{
    robocup = robocup_;
}
void LocalisationService::setLocBinding(Vision_obj::LocalisationBinding *locBinding_)
{
