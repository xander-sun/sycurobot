...
#ifdef VISION_COMPONENT
        void setRobocup(Vision_obj::Robocup *robocup);
        void setLocBinding(Vision_obj::LocalisationBinding * locBinding);
#endif
...
#ifdef VISION_COMPONENT
        Vision_obj::Robocup *robocup;
        Vision_obj::LocalisationBinding * locBinding;
#endif
