...
void CameraCalibration::step(float elapsed)
{
    ...
    double currentTargetX = RhIO::Root.getFloat(
        "Vision_obj/Calibration/targetX");
    double currentTargetY = RhIO::Root.getFloat(
        "Vision_obj/Calibration/targetY");
    if (
        currentTargetX > -1.0 && 
        currentTargetX < 1.0 &&
        currentTargetY > -1.0 && 
        ...
        if (isSuccess) {
            RhIO::Root.setFloat(
                "Vision_obj/Calibration/estimateX", pixel.x());
            RhIO::Root.setFloat(
                "Vision_obj/Calibration/estimateY", pixel.y());
        } else {
            RhIO::Root.setFloat(
                "Vision_obj/Calibration/estimateX", 2.0);
            RhIO::Root.setFloat(
                "Vision_obj/Calibration/estimateY", 2.0);
        }
    }
...
bool CameraCalibration::setNextPoint()
{
    ...
    if (_calibIndex/_samplesNumber >= GroundTargetsValue.size()) {
        RhIO::Root.setFloat(
            "Vision_obj/Calibration/targetX", 2.0);
        RhIO::Root.setFloat(
            "Vision_obj/Calibration/targetY", 2.0);
        RhIO::Root.setFloat(
            "Vision_obj/Calibration/estimateX", 2.0);
        RhIO::Root.setFloat(
            "Vision_obj/Calibration/estimateY", 2.0);
    ...
    RhIO::Root.setFloat(
        "Vision_obj/Calibration/targetX", _pixelPoint.x());
    RhIO::Root.setFloat(
        "Vision_obj/Calibration/targetY", _pixelPoint.y());
